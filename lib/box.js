...
d3.box = function() {
  ...
  function box(g) {
    g.each(function(d, i) {
      ...
      console.log(min,max,quartileData)
      ...
      center.enter().insert("line", "rect")
          ...
          .attr("y1", height / 2)
          .attr("x1", function() { return x0.range()[0] - padding; })
          .attr("y2", height / 2)
          .attr("x2", function() { return x0.range()[1] + padding; })
          .style("opacity", 0.)
          .style("color", "#efefef");
      ...
      boxTick.enter().append("text")
          .attr("class", "box")
          // .attr("dx", ".3em")
          .attr("dy", function(d, i) { return i & 1 ? 10 : -6 })
